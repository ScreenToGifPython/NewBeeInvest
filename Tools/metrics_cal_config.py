...
log_return_relative_metrics_dict = {
    ...
    'ReturnZScore_1y':
        ['当前平均收益相对近1年收益的 Z 分数',
         ...
         ['1d', '2d', '3d', '1w', '2w', '1m', '2m', '3m', '5m', '6m', 'mtd', 'qtd'],
         ],
    'ReturnZScore_2y':
        ['当前平均收益相对近2年收益的 Z 分数',
    ...
    'VolatilityRollingRatio_2m':
        ['当前波动率相较近2个月波动率的滚动比率',
         '波动率滚动比率 = 当前波动率 / 近2个月波动率 (值 > 1 表示近期强于长期（上升趋势），< 1 则反之)',
         ['1w', '2w', '1m'],
         ],
    'VolatilityRollingRatio_6m':
        ['当前波动率相较近6个月波动率的滚动比率',
         '波动率滚动比率 = 当前波动率 / 近6个月波动率 (值 > 1 表示近期强于长期（上升趋势），< 1 则反之)',
         ['1w', '2w', '1m', '2m', '3m'],
         ],
    'VolatilityRollingRatio_1y':
        ['当前波动率相较近1年波动率的滚动比率',
         '波动率滚动比率 = 当前波动率 / 近1年波动率 (值 > 1 表示近期强于长期（上升趋势），< 1 则反之)',
         ['1w', '2w', '1m', '2m', '3m', '5m', '6m', 'mtd', 'qtd'],
         ],
    'VolatilityRollingRatio_2y':
        ['当前波动率相较近2年波动率的滚动比率',
         '波动率滚动比率 = 当前波动率 / 近2年波动率 (值 > 1 表示近期强于长期（上升趋势），< 1 则反之)',
